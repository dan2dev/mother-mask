...
import type { LitMaskDecimal, LitMaskInput } from 'mother-mask/lit'
import { formatDecimalValue } from 'mother-mask'
import './style.css'

const amountOptions = { decimalPlaces: 2, prefix: '$', allowNegative: true }

const phone = document.querySelector<LitMaskInput>('#phone')!
const amount = document.querySelector<LitMaskDecimal>('#amount')!
