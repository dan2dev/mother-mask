// Keep this a self-reference: the built Mithril entry aliases the core
...
export type { InputMaskAttrs } from './InputMask'
export { InputDecimal } from './InputDecimal'
export type { InputDecimalAttrs } from './InputDecimal'
