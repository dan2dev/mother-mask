      ...
      div(
        ...
        Feature(
          ...
          p(
            ...
            ' min+gz, with zero runtime dependencies.',
          ),
        ),
        Feature(
          'code-icon',
          'Multiframework',
          'Meet users anywhere',
          p('One core API with dedicated bindings for every major framework — React, Vue, Angular, Svelte, Solid, Web Components, and more.'),
        ),
        Feature(
          'puzzle-icon',
          'Flexible',
          'Model real formats',
          p('Compose custom tokens, character transforms, locale-aware decimals, and content-dependent masks.'),
        ),
        Feature(
          'heart-icon',
          'Natural',
          'Respect the caret',
          p('Cursor position, pasting, and selection edits behave exactly as they would in a native input — no jumping caret, no lost keystrokes.'),
        ),
      ),
    ),
    ...
    section(
      ...
      div(
        ...
        div(
          ...
          p('Drop mother-mask into a form field in a few lines — no dependencies, full keyboard and IME support, and a binding for whatever framework you already use.'),
        ),
        div(
